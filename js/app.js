...
    try {
        // ⚠️ यहाँ 'YOUR_GOOGLE_SHEET_ID_HERE' को हटाकर अपनी असली गूगल शीट आईडी डालें
...
        
        // CSV डेटा को ऑटोमैटिकली वेबसाइट के अनुकूल JSON फॉर्मेट में बदलने का इंजन
...
            
            // अल्पविराम (comma) और उद्धरण चिह्नों (quotes) को सुरक्षित रखने वाला रेगुलर एक्सप्रेशन स्प्लिटर
...
                // थंबनेल गैलरी का ऑटोमैटिक बैकअप पाथ ताकि कोई इमेज बॉक्स न टूटे
                product.media = [
